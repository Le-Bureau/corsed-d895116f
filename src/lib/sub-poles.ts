  ...
  nettoyage: {
    toitures: {
      ...
      domaines: [
        ...
        { iconName: "Building", category: "Hôtellerie", title: "Hôtels et résidences touristiques", description: "Préparation avant saison, entretien régulier ou remise en état ponctuelle. Intervention discrète, sans perturber l’activité touristique ni l’image de votre établissement.", highlightLabel: "Toutes saisons", highlightDescription: "Interventions toute l'année" },
    ...
    facades: {
      ...
      domaines: [
        { iconName: "Home", category: "Enduits", title: "Enduits minéraux et modernes", description: "La majorité des façades corses récentes. Enduits grattés, talochés, hydrauliques ou monocouches : traitement doux adapté pour éliminer traces vertes et noircissement sans altération.", highlightLabel: "Support courant", highlightDescription: "majorité des villas récentes" },
    ...
    "panneaux-solaires": {
      ...
      domaines: [
        { iconName: "Home", category: "Particuliers", title: "Maisons individuelles", description: "Installations résidentielles de 3 à 12 kWc en autoconsommation ou revente. Nettoyage en profondeur, sans accès à la toiture, sans risque pour les tuiles ou le bac acier.", highlightLabel: "1 heure", highlightDescription: "intervention moyenne" },
