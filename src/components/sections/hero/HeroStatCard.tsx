...
const HeroStatCard = ({ pole, direction }: HeroStatCardProps) => {
  ...
  return (
    <motion.div
      ...
      animate="center"
      exit="exit"
      className="hidden md:block absolute bottom-28 lg:bottom-8 right-5 md:right-10 z-[15] glass-light-strong rounded-2xl px-6 py-4 min-w-[220px] [@media(max-height:760px)]:lg:hidden"
    >
