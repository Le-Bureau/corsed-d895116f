...
const HeroCarousel = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-24 md:top-28 left-1/2 -translate-x-1/2 xl:left-[clamp(24px,4vw,56px)] xl:translate-x-0 xl:top-2 z-20 pointer-events-none hidden md:block leading-none">
