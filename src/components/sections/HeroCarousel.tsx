...
function getTitleProps(
  ...
  const fallbackShift = isMobile ? viewportWidth * 2 : viewportWidth * 0.72;
        ...
        <div className="w-full px-5 md:pl-[clamp(120px,11vw,180px)] md:pr-[clamp(120px,11vw,180px)]">
          <div className="w-full max-w-[780px]">
            {/* Pole pill eyebrow — temporairement masquée (à réactiver en retirant `hidden`
                ici et le spacer correspondant dans HeroSlideContent.tsx) */}
            <div className="hidden">
              <div className="md:inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/[0.05] backdrop-blur-md border border-white/10 text-[13px] font-medium uppercase tracking-[0.18em] text-text-on-dark-muted mb-3">
                <span
